...
🎓 B.Tech Civil Engineering @ MANIT Bhopal (Batch 2025–29)  
🤖 ML/Data Science enthusiast building end-to-end projects  
🏎️ Formula 1 fanatic  
🎯 Targeting Analytics Consulting @ ZS Associates & Deloitte  
...
|---------|-------------|------|----------|
| 🏎️ F1 Race Winner Predictor | Predicts F1 race winners using 5 seasons of real data | XGBoost, FastF1, Streamlit | [Live](YOUR_F1_URL) |
...
**Currently Learning**  
![LSTM](https://img.shields.io/badge/LSTM-RNN-blueviolet?style=flat)
![DSA](https://img.shields.io/badge/DSA-C++-00599C?style=flat&logo=cplusplus&logoColor=white)
